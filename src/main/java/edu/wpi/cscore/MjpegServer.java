...
public class MjpegServer extends VideoSink {
  ...
  public MjpegServer(String name, String listenAddress, int port) {
    super(0 /*CameraServerJNI.createMjpegServer(name, listenAddress, port)*/);
  }
  ...
  public String getListenAddress() {
    return "addr"; //CameraServerJNI.getMjpegServerListenAddress(m_handle);
  }
   ...
   */
  public int getPort() {
    return 80; //CameraServerJNI.getMjpegServerPort(m_handle);
  }
