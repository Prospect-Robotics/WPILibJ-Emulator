...
public class VideoSink implements AutoCloseable {
   ...
   */
  public Kind getKind() {
    return Kind.kUnknown; //getKindFromInt(CameraServerJNI.getSinkKind(m_handle));
  }
  ...
  public String getName() {
    return "name"; //CameraServerJNI.getSinkName(m_handle);
  }
  ...
  public String getDescription() {
    return "desc"; //CameraServerJNI.getSinkDescription(m_handle);
  }
  ...
  public VideoProperty getProperty(String name) {
    return null; //new VideoProperty(CameraServerJNI.getSinkProperty(m_handle, name));
  }
  ...
  public VideoProperty[] enumerateProperties() {
    int[] handles = new int[0]; //CameraServerJNI.enumerateSinkProperties(m_handle);
  ...
  public boolean setConfigJson(String config) {
    return true; //CameraServerJNI.setSinkConfigJson(m_handle, config);
  }
...
//    }
  ...
  public VideoSource getSource() {
    ...
    return null; //new VideoSource(CameraServerJNI.getSinkSource(m_handle));
  }
  ...
  public static VideoSink[] enumerateSinks() {
    int[] handles = new int[0]; //CameraServerJNI.enumerateSinks();
