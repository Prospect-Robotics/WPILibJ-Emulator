...
public abstract class InterruptableSensorBase extends SendableBase {
   ...
   */
  protected int m_interrupt = 0; //InterruptJNI.HalInvalidHandle;
...
//    setUpSourceEdge(true, false);
  ...
  protected void allocateInterrupts(boolean watcher) {
    ...
    m_interrupt = 0; //InterruptJNI.initializeInterrupts(watcher);
  }
  ...
  public WaitResult waitForInterrupt(double timeout, boolean ignorePrevious) {
    ...
    int result = 0; //InterruptJNI.waitForInterrupt(m_interrupt, timeout, ignorePrevious);
  ...
  public double readRisingTimestamp() {
    ...
    return 0; //InterruptJNI.readInterruptRisingTimestamp(m_interrupt) * 1e-6;
  }
  ...
  public double readFallingTimestamp() {
    ...
    return 0; //InterruptJNI.readInterruptFallingTimestamp(m_interrupt) * 1e-6;
  }
