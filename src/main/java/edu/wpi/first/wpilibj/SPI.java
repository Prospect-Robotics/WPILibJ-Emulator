...
public class SPI implements AutoCloseable {
  ...
  public int write(byte[] dataToSend, int size) {
    ...
    return size; //SPIJNI.spiWriteB(m_port, dataToSend, (byte) size);
  }
  ...
  public int write(ByteBuffer dataToSend, int size) {
    ...
    return size; //SPIJNI.spiWrite(m_port, dataToSend, (byte) size);
  }
  ...
  public int read(boolean initiate, byte[] dataReceived, int size) {
    ...
    return size; //SPIJNI.spiReadB(m_port, initiate, dataReceived, (byte) size);
  }
  ...
  public int read(boolean initiate, ByteBuffer dataReceived, int size) {
    ...
    return size; //SPIJNI.spiRead(m_port, initiate, dataReceived, (byte) size);
  }
  ...
  public int transaction(byte[] dataToSend, byte[] dataReceived, int size) {
    ...
    return size; //SPIJNI.spiTransactionB(m_port, dataToSend, dataReceived, (byte) size);
  }
  ...
  public int transaction(ByteBuffer dataToSend, ByteBuffer dataReceived, int size) {
    ...
    return size; //SPIJNI.spiTransaction(m_port, dataToSend, dataReceived, (byte) size);
  }
...
//                               source.getAnalogTriggerTypeForRouting(), rising, falling);
  ...
  public int readAutoReceivedData(ByteBuffer buffer, int numToRead, double timeout) {
    ...
    return 0; //SPIJNI.spiReadAutoReceivedData(m_port, buffer, numToRead, timeout);
  }
  ...
  public int getAutoDroppedCount() {
    return 0; //SPIJNI.spiGetAutoDroppedCount(m_port);
  }
    ...
    void update() {
      synchronized (m_mutex) {
        ...
        while (!done) {
          ...
          int numToRead = 0; //SPIJNI.spiReadAutoReceivedData(m_port, m_buf, 0, 0);
