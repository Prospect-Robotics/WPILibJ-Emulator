...
public class PWM extends MotorSafety implements Sendable, AutoCloseable {
  ...
  public PWM(final int channel) {
    ...
    m_handle = 0; //PWMJNI.initializePWMPort(HAL.getPort((byte) channel));
...
//  }
  ...
  public double getPosition() {
    return 0.5; //PWMJNI.getPWMPosition(m_handle);
  }
  ...
  public double getSpeed() {
    return 0.5; //return PWMJNI.getPWMSpeed(m_handle);
  }
   ...
   */
  public int getRaw() {
    return 128; //return PWMJNI.getPWMRaw(m_handle);
  }
