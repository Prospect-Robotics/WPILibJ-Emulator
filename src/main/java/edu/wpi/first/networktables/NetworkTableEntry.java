...
public final class NetworkTableEntry {
  ...
  public boolean exists() {
    return false; //NetworkTablesJNI.getType(m_handle) != 0;
  }
  ...
  public String getName() {
    return "no name"; //NetworkTablesJNI.getEntryName(m_handle);
  }
  ...
  public NetworkTableType getType() {
    return null; //NetworkTableType.getFromInt(NetworkTablesJNI.getType(m_handle));
  }
   ...
   */
  public int getFlags() {
    return 0; //NetworkTablesJNI.getEntryFlags(m_handle);
  }
  ...
  public long getLastChange() {
    return 0; //NetworkTablesJNI.getEntryLastChange(m_handle);
  }
  ...
  public EntryInfo getInfo() {
    return null; //NetworkTablesJNI.getEntryInfoHandle(m_inst, m_handle);
  }
  ...
  public NetworkTableValue getValue() {
    return null; //NetworkTablesJNI.getValue(m_handle);
  }
  ...
  public boolean getBoolean(boolean defaultValue) {
    return defaultValue; //NetworkTablesJNI.getBoolean(m_handle, defaultValue);
  }
  ...
  public double getDouble(double defaultValue) {
    return defaultValue; //NetworkTablesJNI.getDouble(m_handle, defaultValue);
  }
  ...
  public Number getNumber(Number defaultValue) {
    return defaultValue; //NetworkTablesJNI.getDouble(m_handle, defaultValue.doubleValue());
  }
  ...
  public String getString(String defaultValue) {
    return defaultValue; //NetworkTablesJNI.getString(m_handle, defaultValue);
  }
  ...
  public byte[] getRaw(byte[] defaultValue) {
    return defaultValue; //NetworkTablesJNI.getRaw(m_handle, defaultValue);
  }
  ...
  public boolean[] getBooleanArray(boolean[] defaultValue) {
    return defaultValue; //NetworkTablesJNI.getBooleanArray(m_handle, defaultValue);
  }
   ...
   */
  public Boolean[] getBooleanArray(Boolean[] defaultValue) {
    return defaultValue; /*NetworkTableValue.fromNative(NetworkTablesJNI.getBooleanArray(m_handle,
  ...
  public double[] getDoubleArray(double[] defaultValue) {
    return defaultValue; //NetworkTablesJNI.getDoubleArray(m_handle, defaultValue);
  }
   ...
   */
  public Double[] getDoubleArray(Double[] defaultValue) {
    return defaultValue; /*NetworkTableValue.fromNative(NetworkTablesJNI.getDoubleArray(m_handle,
        NetworkTableValue.toNative(defaultValue))); */
  }
  ...
  public String[] getStringArray(String[] defaultValue) {
    return defaultValue; //NetworkTablesJNI.getStringArray(m_handle, defaultValue);
  }
...
//          // TODO
  ...
  public boolean setDefaultBoolean(boolean defaultValue) {
    return false; //NetworkTablesJNI.setDefaultBoolean(m_handle, 0, defaultValue);
  }
  ...
  public boolean setDefaultDouble(double defaultValue) {
    return false; //NetworkTablesJNI.setDefaultDouble(m_handle, 0, defaultValue);
  }
  ...
  public boolean setDefaultNumber(Number defaultValue) {
    return false; //NetworkTablesJNI.setDefaultDouble(m_handle, 0, defaultValue.doubleValue());
  }
  ...
  public boolean setDefaultString(String defaultValue) {
    return false; //NetworkTablesJNI.setDefaultString(m_handle, 0, defaultValue);
  }
  ...
  public boolean setDefaultRaw(byte[] defaultValue) {
    return false; //NetworkTablesJNI.setDefaultRaw(m_handle, 0, defaultValue);
  }
  ...
  public boolean setDefaultBooleanArray(boolean[] defaultValue) {
    return false; //NetworkTablesJNI.setDefaultBooleanArray(m_handle, 0, defaultValue);
  }
   ...
   */
  public boolean setDefaultBooleanArray(Boolean[] defaultValue) {
    return false; /*NetworkTablesJNI.setDefaultBooleanArray(m_handle,
  ...
  public boolean setDefaultDoubleArray(double[] defaultValue) {
    return false; //NetworkTablesJNI.setDefaultDoubleArray(m_handle, 0, defaultValue);
  }
  ...
  public boolean setDefaultNumberArray(Number[] defaultValue) {
    return false; /*NetworkTablesJNI.setDefaultDoubleArray(m_handle,
        0, NetworkTableValue.toNative(defaultValue));*/
  }
  ...
  public boolean setDefaultStringArray(String[] defaultValue) {
    return false; //NetworkTablesJNI.setDefaultStringArray(m_handle, 0, defaultValue);
  }
...
//          // TODO
  ...
  public boolean setBoolean(boolean value) {
    return false; //NetworkTablesJNI.setBoolean(m_handle, 0, value, false);
  }
  ...
  public boolean setDouble(double value) {
    return false; //NetworkTablesJNI.setDouble(m_handle, 0, value, false);
  }
  ...
  public boolean setNumber(Number value) {
    return false; //NetworkTablesJNI.setDouble(m_handle, 0, value.doubleValue(), false);
  }
  ...
  public boolean setString(String value) {
    return false; //NetworkTablesJNI.setString(m_handle, 0, value, false);
  }
  ...
  public boolean setRaw(byte[] value) {
    return false; //NetworkTablesJNI.setRaw(m_handle, 0, value, false);
  }
  ...
  public boolean setRaw(ByteBuffer value, int len) {
    ...
    return false; //NetworkTablesJNI.setRaw(m_handle, 0, value, len, false);
  }
  ...
  public boolean setBooleanArray(boolean[] value) {
    return false; //NetworkTablesJNI.setBooleanArray(m_handle, 0, value, false);
  }
   ...
   */
  public boolean setBooleanArray(Boolean[] value) {
    return false; //NetworkTablesJNI.setBooleanArray(m_handle, 0, NetworkTableValue.toNative(value), false);
  }
  ...
  public boolean setDoubleArray(double[] value) {
    return false; //NetworkTablesJNI.setDoubleArray(m_handle, 0, value, false);
  }
  ...
  public boolean setNumberArray(Number[] value) {
    return false; //NetworkTablesJNI.setDoubleArray(m_handle, 0, NetworkTableValue.toNative(value), false);
  }
  ...
  public boolean setStringArray(String[] value) {
    return false; //NetworkTablesJNI.setStringArray(m_handle, 0, value, false);
  }
...
//          // TODO
  ...
  public RpcCall callRpc(byte[] params) {
    return new RpcCall(this, 0 /*NetworkTablesJNI.callRpc(m_handle, params)*/);
  }
